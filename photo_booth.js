...
function sendEmailWithAttachment(fileName, receiver, img) {
  ...
  fs.readFile(img, function (err, data) {
    transporter.sendMail({
        ...
        to: receiver,
        subject: 'Hello from TJBot',
        text: 'Hi! This are the pictures you took on Future Port Prague. We would love to see you again, so don\'t forget to follow your facebook group: https://www.facebook.com/groups/tjbotcz',
